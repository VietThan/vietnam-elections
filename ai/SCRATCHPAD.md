...
- [ ] Configure static export for GitHub Pages in `next.config.ts` (basePath/assetPrefix, `images.unoptimized`, `trailingSlash`)
- [ ] Replace `app/page.tsx` with project home (non-starter content)
- [ ] Add minimal navigation shell in `app/layout.tsx`
...
- [ ] Verify staging schema aligns with plan tables (cycle/locality/constituency/person/entry/source/document)
